...
[[resources-project-video-create]]
=== Project Video 업로드
`POST` 요청을 사용해서 Project에 Video을 업로드할 수 있습니다.
...
===== http-request
include::{snippets}/project-video-create/http-request.adoc[]

===== request-path-parameters
include::{snippets}/project-video-create/path-parameters.adoc[]

===== request-parts
include::{snippets}/project-video-create/request-parts.adoc[]

==== Response

===== http-response
include::{snippets}/project-video-create/http-response.adoc[]
