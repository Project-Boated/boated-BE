...
===== response-headers
include::{snippets}/account-profile-update/response-headers.adoc[]

===== response-fields
include::{snippets}/account-profile-update/response-fields.adoc[]
...
===== request-headers
include::{snippets}/account-profile-delete/request-headers.adoc[]
...
===== response-headers
include::{snippets}/account-profile-delete/response-headers.adoc[]

===== response-fields
include::{snippets}/account-profile-delete/response-fields.adoc[]
