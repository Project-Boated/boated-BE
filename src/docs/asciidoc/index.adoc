...
===== http-request
include::{snippets}/task-assign/http-request.adoc[]

===== request-headers
include::{snippets}/task-assign/request-headers.adoc[]

===== request-path-parameters
include::{snippets}/task-assign/path-parameters.adoc[]

===== request-fields
include::{snippets}/task-assign/request-fields.adoc[]

==== Response

===== http-response
include::{snippets}/task-assign/http-response.adoc[]
