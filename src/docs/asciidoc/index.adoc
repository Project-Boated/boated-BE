...
===== http-request
include::{snippets}/kanban-lane-index-change/http-request.adoc[]

===== request-path-parameters
include::{snippets}/kanban-lane-index-change/path-parameters.adoc[]

==== Response

===== http-response
include::{snippets}/kanban-lane-index-change/http-response.adoc[]
