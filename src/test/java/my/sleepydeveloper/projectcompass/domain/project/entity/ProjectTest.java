...
class ProjectTest extends BaseTest {
    ...
    void changeCaptain_captain바꾸기_바꾸기성공() throws Exception {
        // Given
        Account existingCaptain = new Account(USERNAME, PASSWORD, NICKNAME, PROFILE_IMAGE_FILE, ROLES);
        Project project = new Project(PROJECT_NAME, PROJECT_DESCRIPTION, existingCaptain, PROJECT_DEADLINE);

        // When
        Account newCaptain = new Account(newCaptainUsername, PASSWORD, newCaptainNickname, PROFILE_IMAGE_FILE, ROLES);
