...
class ProjectQueryDslRepositoryImplTest {
    ...
    public void getMyProject_모든경우프로젝트1개있음_프로젝트4개조회() {
        // Given
        Account account1 = new Account(ACCOUNT_ID, BasicDataAccount.USERNAME, BasicDataAccount.PASSWORD, BasicDataAccount.NICKNAME, null, null);
        accountRepository.save(account1);
        Account account2 = new Account(ACCOUNT_ID, "crewUsername", BasicDataAccount.PASSWORD, "crewNickname", null, null);
        accountRepository.save(account2);

        Project project1 = new Project(account1, BasicDataProject.PROJECT_NAME+1, BasicDataProject.PROJECT_DESCRIPTION, LocalDateTime.now());
        projectRepository.save(project1);
        Project project2 = new Project(account1, BasicDataProject.PROJECT_NAME+2, BasicDataProject.PROJECT_DESCRIPTION, LocalDateTime.now());
        project2.terminateProject();
        projectRepository.save(project2);

        Project project3 = new Project(account2, BasicDataProject.PROJECT_NAME+3, BasicDataProject.PROJECT_DESCRIPTION, LocalDateTime.now());
        projectRepository.save(project3);
        Project project4 = new Project(account2, BasicDataProject.PROJECT_NAME+4, BasicDataProject.PROJECT_DESCRIPTION, LocalDateTime.now());
    ...
    public void getMyProject_captain인종료되지않은프로젝트1개있음_프로젝트1개조회() {
        // Given
        Account captain = new Account(ACCOUNT_ID, BasicDataAccount.USERNAME, BasicDataAccount.PASSWORD, BasicDataAccount.NICKNAME, null, null);
        accountRepository.save(captain);

        Project project = new Project(captain, BasicDataProject.PROJECT_NAME, BasicDataProject.PROJECT_DESCRIPTION, LocalDateTime.now());
        ...
        // Then
        assertThat(list).extracting("name", "description").contains(tuple(BasicDataProject.PROJECT_NAME, BasicDataProject.PROJECT_DESCRIPTION));
    }
    ...
    public void getMyProject_crew인종료되지않은프로젝트1개있음_프로젝트1개조회() {
        ...
        Account captain = new Account(ACCOUNT_ID, BasicDataAccount.USERNAME, BasicDataAccount.PASSWORD, BasicDataAccount.NICKNAME, null, null);
        accountRepository.save(captain);
        Account crew = new Account(ACCOUNT_ID, "crewUsername", BasicDataAccount.PASSWORD, "crewNickname", null, null);
