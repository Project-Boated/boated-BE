package com.projectboated.backend.ganttchart.controller;

import com.projectboated.backend.account.account.entity.Account;
import com.projectboated.backend.ganttchart.controller.document.GanttChartDocument;
...
class GanttChartControllerTest extends ControllerTest {
    ...
    void GetMyGanttChart_조회_조회정상() throws Exception {
        ...
        mockMvc.perform(get("/api/my/gantt-chart")
                ...
                .andDo(GanttChartDocument.documentMyGanttChartRetrieve());
    }
