...
import com.projectboated.backend.domain.account.account.service.exception.AccountProfileImageNotSupportTypeException;
...
public class AccountProfileImageService {
    ...
    public void updateProfileImage(Account account, ProfileImage newProfileImage) {
        ...
        findAccount.changeProfileImage(newProfileImage);
    }
